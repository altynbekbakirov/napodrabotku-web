<div class="card-body">
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-2">
            {!! Form::select('currency', $currencies, null, [
                'class' => 'selectpicker ' . $errors->first('currency', 'is-invalid') . '',
                'title' => 'Выбрать',
                'data-width' => '100%',
        ...
        <div class="col-lg-2">
            {!! Form::select(
                'period',
                [
                    'Ставка за час' => 'Ставка за час',
                    'Ставка за смену' => 'Ставка за смену',
                    'В неделю' => 'В неделю',
                    'В месяц' => 'В месяц',
                ],
                null,
                [
                    'class' => 'selectpicker ' . $errors->first('period', 'is-invalid') . '',
    ...
    @if (auth()->user()->type == 'ADMIN')
        <div class="form-group row">
            ...
            <div class="col-lg-4">
                {!! Form::select('company_id', $companies, auth()->user()->type == 'COMPANY' ? auth()->user()->id : null, [
                    'class' => 'selectpicker ' . $errors->first('company_id', 'is-invalid') . '',
                    'title' => 'Выбрать',
                    'data-width' => '100%',
                    'data-live-search' => 'true',
                    'data-size' => '6',
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-8">
            {!! Form::textarea('description', null, [
                'class' => 'tox-target form-control ' . $errors->first('description', 'is-invalid') . '',
                'rows' => '6',
                'id' => 'kt-tinymce-app',
            ]) !!}
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-4">
            {!! Form::select('busyness_id', $busynesses, null, [
                'class' => 'selectpicker ' . $errors->first('busyness_id', 'is-invalid') . '',
                'title' => 'Выбрать',
                'data-width' => '100%',
                'data-live-search' => 'true',
                'data-size' => '6',
    ...
    <div class="form-group row">
        <label class="col-lg-3 col-form-label">Выберите профессию: <span style="color: red">*</span></label>
        <div class="col-lg-4">
            {!! Form::select('vacancy_type_id', $vacancy_types, null, [
                'class' => 'selectpicker ' . $errors->first('vacancy_type_id', 'is-invalid') . '',
                'title' => 'Выбрать',
                'data-width' => '100%',
                'data-live-search' => 'true',
                'data-size' => '6',
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-4">
            {!! Form::select('job_type_id', $job_types, null, [
                'class' => 'selectpicker ' . $errors->first('job_type_id', 'is-invalid') . '',
                'title' => 'Выбрать',
                'data-width' => '100%',
                'data-live-search' => 'true',
                'data-size' => '6',
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-4">
            {!! Form::select('schedule_id', $schedules, null, [
                'class' => 'selectpicker ' . $errors->first('schedule_id', 'is-invalid') . '',
                'title' => 'Выбрать',
                'data-width' => '100%',
                'data-live-search' => 'true',
                'data-size' => '6',
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-4">
            {!! Form::select('experience', ['Без опыта', 'Полгода', 'Более года'], null, [
                'class' => 'selectpicker ' . $errors->first('experience', 'is-invalid') . '',
                'title' => 'Выбрать',
                'data-width' => '100%',
                'data-live-search' => 'true',
                'data-size' => '6',
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-4">
            {!! Form::select('pay_period', ['Ежедневная', 'Еженедельная', 'Ежемесячная'], null, [
                'class' => 'selectpicker ' . $errors->first('pay_period', 'is-invalid') . '',
                'title' => 'Выбрать',
                'data-width' => '100%',
                'data-live-search' => 'true',
                'data-size' => '6',
